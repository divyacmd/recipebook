...
import { getForeign, updateForeign } from '../services/foreignService'
...
class UpdateForeign extends Component {
	state = {
		_id: this.props.id,
	...
	async componentDidMount() {
		const oldData = await getForeign(this.props.id);
